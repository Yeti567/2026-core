...
-- Wrapped in DO block to handle IF NOT EXISTS for indexes which isn't fully supported in all pg versions for some syntax, or just to be safe
DO $$ BEGIN
...
DROP POLICY IF EXISTS "certifications_insert_policy" ON certifications;
