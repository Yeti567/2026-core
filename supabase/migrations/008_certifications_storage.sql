...
COMMENT ON POLICY "Company members can view certificates" ON storage.objects IS 
  'Allows authenticated users to view certificates belonging to their company';

COMMENT ON POLICY "Admins can upload certificates" ON storage.objects IS 
  'Allows admins and supervisors to upload certificates for their company''s workers';
