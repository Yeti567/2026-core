...
CREATE INDEX IF NOT EXISTS idx_mock_interview_sessions_company_id ON mock_interview_sessions(company_id);
CREATE INDEX IF NOT EXISTS idx_mock_interview_sessions_worker_id ON mock_interview_sessions(worker_id);
CREATE INDEX IF NOT EXISTS idx_mock_interview_sessions_user_profile_id ON mock_interview_sessions(user_profile_id);
CREATE INDEX IF NOT EXISTS idx_mock_interview_sessions_status ON mock_interview_sessions(status);
CREATE INDEX IF NOT EXISTS idx_mock_interview_reports_company_id ON mock_interview_reports(company_id);
CREATE INDEX IF NOT EXISTS idx_mock_interview_reports_session_id ON mock_interview_reports(session_id);
CREATE INDEX IF NOT EXISTS idx_mock_interview_reports_worker_id ON mock_interview_reports(worker_id);
CREATE INDEX IF NOT EXISTS idx_mock_interview_reports_ready ON mock_interview_reports(ready_for_audit);
...
DROP POLICY IF EXISTS "mock_interview_sessions_select_policy" ON mock_interview_sessions;
...
DROP POLICY IF EXISTS "mock_interview_sessions_insert_policy" ON mock_interview_sessions;
...
DROP POLICY IF EXISTS "mock_interview_sessions_update_policy" ON mock_interview_sessions;
...
DROP POLICY IF EXISTS "mock_interview_sessions_delete_policy" ON mock_interview_sessions;
...
DROP POLICY IF EXISTS "mock_interview_reports_select_policy" ON mock_interview_reports;
...
DROP POLICY IF EXISTS "mock_interview_reports_insert_policy" ON mock_interview_reports;
...
DROP POLICY IF EXISTS "mock_interview_reports_update_policy" ON mock_interview_reports;
...
DROP POLICY IF EXISTS "mock_interview_reports_delete_policy" ON mock_interview_reports;
