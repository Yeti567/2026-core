...
CREATE INDEX IF NOT EXISTS idx_registration_tokens_email ON registration_tokens(registrant_email);
CREATE INDEX IF NOT EXISTS idx_registration_tokens_wsib ON registration_tokens(wsib_number);
CREATE INDEX IF NOT EXISTS idx_registration_tokens_status ON registration_tokens(status) WHERE status = 'pending';
...
CREATE INDEX IF NOT EXISTS idx_registration_attempts_email_time ON registration_attempts(registrant_email, created_at);
